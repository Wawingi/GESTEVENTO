...
<div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                <div class="col-12">
                                    <div style="height:350px;background-color:#c3def9" class="card-box widget-user">
                                            ...
                                            <div style="width:1200px" class="portfolioContainer">
                                                <div class="col-sm-6 col-lg-3 col-md-4 webdesign illustrator">
                                                    <div class="gal-detail thumb">
                                                        <a href='{{ url("images/qrcodes/{$img}") }}' class="image-popup" title="Screenshot-1">
                                                            <img style="width:250px;height:200px" src='{{ url("images/qrcodes/{$img}") }}' class="thumb-img" alt="work-thumbnail">
                                                        </a>
